...
l8NDVI_agg <-l8NDVI2$reproject(projExample)$reduceResolution(reducer=ee$Reducer$mean())$reproject(projExample)


# ee_print(l8NDVI_agg)

saveTest <- ee_image_to_drive(image=l8NDVI_agg, description="landsat8_NDVI", fileNamePrefix="landsat8_NDVI", folder=GoogleFolderSave, timePrefix = F, region = chiBBox, maxPixels = 10e12, crs=projCRS, crsTransform=projTransform)
# ee_image_to_drive(image=l9Agg$select("NDVI"), description="landsat9_NDVI4", fileNamePrefix="landsat9_NDVI-Agg4", folder=GoogleFolderSave, timePrefix = F, region = sampleGT$geometry(), maxPixels = 10e12, scale=4470.698, crs=projCRS, crsTransform=projTransform)
...
l9NDVI_agg <-l9NDVI2$reproject(projExample)$reduceResolution(reducer=ee$Reducer$mean())$reproject(projExample)


ee_print(l9NDVI_agg)
saveTest <- ee_image_to_drive(image=l9NDVI_agg, description="landsat9_NDVI", fileNamePrefix="landsat9_NDVI", folder=GoogleFolderSave, timePrefix = F, region = chiBBox, maxPixels = 10e12, crs=projCRS, crsTransform=projTransform)
saveTest$start()
...
l7NDVI_agg <-l7NDVI2$reproject(projExample)$reduceResolution(reducer=ee$Reducer$mean())$reproject(projExample)


saveTest <- ee_image_to_drive(image=l7NDVI_agg, description="landsat7_NDVI", fileNamePrefix="landsat7_NDVI", folder=GoogleFolderSave, timePrefix = F, region = chiBBox, maxPixels = 10e12, crs=projCRS, crsTransform=projTransform)
saveTest$start()
...
l5NDVI_agg <-l5NDVI2$reproject(projExample)$reduceResolution(reducer=ee$Reducer$mean())$reproject(projExample)
